...
function mostrar_objeto_flash (nombre,cualswf,ancho,alto,modo,vars) {
	document.write('<div id="'+nombre+'">');
	document.write('<script type="text/javascript">');
	var nombre=new SWFObject(cualswf,nombre,ancho,alto,"7","#000000");
	nombre.addParam("wmode", modo);
	nombre.addParam("quality", "high");
	nombre.addParam("menu", "false");
	nombre.addParam("flashvars", vars);
	nombre.write(nombre);				
