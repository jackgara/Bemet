...
/*----------------------------------------------------------------
Para implementar creacion de subdominios usar:
$objDomain = new domain("localhost", "pampawor", "orwell1984", $port = 2082, $ssl = false, $theme = 'x3', "pampaworks.com.ar");
echo $objDomain->addSubdomain("prueba1");
----------------------------------------------------------------*/
